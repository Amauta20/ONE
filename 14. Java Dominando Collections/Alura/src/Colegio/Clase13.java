...
public class Clase13 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Verificar si existe Luis Miguel");
		boolean validar = listaAlumnos.contains("Luis Miguel");
		System.out.println(validar);
		
		System.out.println("Size maximo");
		...
		listaAlumnos.removeIf(alumno -> "Steve Albert".equalsIgnoreCase(alumno));
		System.out.println(listaAlumnos);
